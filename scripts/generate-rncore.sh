...
yarn flow-node $PWD/../packages/react-native-codegen/src/cli/generators/generate-all.js schema-rncore.json rncore ReactCommon/react/renderer/components/rncore rncore
